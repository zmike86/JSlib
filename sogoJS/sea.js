...
(function(util, config, global) {
    ...
    var DIRNAME_RE = /.*(?=\/.*$)/;// 目标文件的上层目录路径
    var MULTIPLE_SLASH_RE = /([^:\/])\/\/+/g;
	var FILE_EXT_RE = /\.(?:css|js)$/; //detect file type
	var ROOT_RE = /^(.*?\w)(?:\/|$)/;
    ...
    */
	...
	var pageUri = loc.protocol + '//' + loc.host + normalizePathname(loc.pathname);
